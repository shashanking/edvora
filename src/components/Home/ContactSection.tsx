...
const FALL_BACK_CONTENT = {
  ...
  description:"Contact us to share your thoughts, ask questions, or explore opportunities to work and grow together.",
  callDescription:"Contact us to share your thoughts, ask questions, or explore opportunities to work and grow together.",
  phone:"+1-323-453-5817",
  emailDescription:"Contact us to share your thoughts, ask questions, or explore opportunities to work and grow together.",
        ...
        <div className="bg-white  rounded-[3rem] p-8 md:p-12 lg:p-16 shadow-lg">
          <div className="flex flex-col md:flex-row items-center gap-8 md:gap-16">
            ...
            <div>
              ...
              <form ref={formRef}
      onSubmit={sendEmail} className="space-y-5">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <input
                    ...
                    className="input-field border border-[#D4D4D4] rounded-full outline-none py-2 pl-5 pr-1.5 font-nunito-sans text-sm leading-none text-[#4D4D4D] opacity-50"
                    required
                  />
                  <input
                    name="lastName"
                ...
                <textarea
                  ...
                  rows={6}
                  placeholder="Message"
                  className="w-full px-6 py-4 border-2 rounded-3xl  focus:outline-none resize-none  border-[#D4D4D4] outline-none font-nunito-sans text-sm leading-none text-[#4D4D4D] opacity-50"
                  required
                />
                ...
                >
                  {
                    loading ? (
                      ...
                      <div className='flex items-center justify-center gap-3'>
                        <span className="font-poppins font-semibold text-[#2B2B2B] text-xl leading-6">Send</span>
            ...
            <div className=" md:h-[420px]">
              ...
              <div className=" mb-6 md:mb-12">
                ...
                <p className="text-[#4D4D4D] mb-2 md:mb-6 font-nunito-sans text-[10px] md:text-base leading-6">
                  {
                    content?.callDescription ?? FALL_BACK_CONTENT?.callDescription
                  }
                </p>

                <a
                  className="flex items-center gap-3 text-[#1F4FD8] font-semibold text-[12px] md:text-xl"
                >
                  ...
                  <span className='text-[#1F4FD8]'>{content?.phone ?? FALL_BACK_CONTENT?.phone}</span>
                </a>
              </div>
              ...
              <div>
                ...
                <p className="text-[#4D4D4D] mb-2 md:mb-6 font-nunito-sans text-[10px] md:text-base leading-6">
                  {
                    content?.emailDescription ?? FALL_BACK_CONTENT?.emailDescription
                  }
                </p>

                <a
                  className="flex items-center gap-3 text-blue-600 font-semibold text-[12px] md:text-xl hover:text-blue-700"
                >
                  <div className="w-5 h-5 md:w-10 md:h-10 rounded-full flex items-center justify-center font-poppins font-bold text-sm leading-none">
                    <img src="./outline-email.png" alt="" />
                  </div>
                  <span className='text-[#1F4FD8]'>{content?.email ?? FALL_BACK_CONTENT?.email}</span>
                </a>
              </div>
                ...
                >
                  {
                    loading ? (
                      ...
                      <div className='flex items-center justify-center gap-3'>
                        <span className="font-poppins font-semibold text-[#2B2B2B] text-[16px] md:text-xl leading-6">Send</span>
                  <img src="paper-plane.png" alt="" />
                      </div>
                    )
                  }
